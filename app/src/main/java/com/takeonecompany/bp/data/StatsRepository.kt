...
import com.takeonecompany.bp.model.TestStats
...
class StatsRepository(context: Context) {
    ...
    private val cache = mutableStateMapOf<String, TestStats>()
    ...
    val statsFlow: Map<String, TestStats> get() = cache

    fun statsFor(testId: String): TestStats = cache[testId] ?: TestStats(testId)
    ...
    fun recordResult(result: TestResult) {
    ...
    private fun readStats(testId: String): TestStats {
    ...
    private fun writeStats(stats: TestStats) {
